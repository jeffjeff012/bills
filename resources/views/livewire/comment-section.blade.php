        ...
        @forelse($comments as $comment)
            <div class="p-2 border-b text-xs sm:text-lg  {{ $comment->is_hidden ? 'opacity-60' : '' }}">
                ...
                @else
                        ...
                        <div class="mt-3">
                            <button 
                                ...
                                @if($comment->is_hidden)
                                    <svg class="w-6 h-6 text-green-800 dark:text-green-800 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    ...
                                    Unhide
                                @else
                                    <svg class="w-6 h-6 text-gray-800 dark:text-blue-800 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <flux:modal name="delete-comment" class="min-w-[10rem] lg:min-w-[22rem]" wire:model="confirmingCommentDeletion">
                        <div class="space-y-6">
                            <div>
