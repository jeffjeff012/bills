                            ...
                            <a href="{{ route('bill', $bill->id) }}" class="block">
                                ...
                                <div class="flex flex-col md:flex-row md:items-center md:gap-4 gap-1 text-xs text-gray-600 dark:text-gray-400">
                                    <div class="flex items-center gap-1.5 md:gap-2">
                                        ...
                                        <span class="truncate">
                                            {{ $bill->contributorType === 'author' ? $bill->authored_by : ($bill->contributorType === 'sponsor' ? $bill->committee->name : 'Unknown') }}
                                        </span>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="mt-6 md:mt-10 space-y-3 md:space-y-4">
                            ...
                            <div class="flex flex-col md:flex-row md:justify-between gap-3 md:gap-0">
                                ...
                                <div class="order-2 md:order-1">
                                    <div class="inline-flex items-center gap-1.5 md:gap-2 px-2.5 py-1 md:px-3 md:py-1.5 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-full border border-blue-200 dark:border-blue-800/100">
