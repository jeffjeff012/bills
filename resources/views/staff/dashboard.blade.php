...
@endsession
    ...
    <!-- Dislikes -->
    <div class="bg-gradient-to-br from-teal-500 to-orange-600 border border-blue-500 text-white p-6 rounded-xl shadow-md shadow-md hover:shadow-xl hover:scale-[1.02] transition-all duration-200 ease-in-out">
        <div class="flex items-center justify-between">
            <div>
